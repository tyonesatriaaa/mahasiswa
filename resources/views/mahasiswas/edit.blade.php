...
<div class="container mt-5"> 
            ...
            @endforeach
                    ...
                    <div class="form-group"> 
                        ...
                        <input type="email" name="email" class="form-control" id="email" value="{{ $mahasiswas->email}}" aria-describedby="email" > 
                    </div> 
                    <div class="form-group"> 
                        <label for="tgl_lahir">Tanggal Lahir</label> 
                        <input type="date" name="tgl_lahir" class="form-control" id="tgl_lahir" value="{{ $mahasiswas->tgl_lahir}}" aria-describedby="tgl_lahir" > 
                    </div>  -->
